...
sum_of_primary_diagonal = sum(x for x in get_primary_diagonal(matrix))
sum_of_secondary_diagonal = sum(x for x in get_secondary_diagonal(matrix))

print(abs(sum_of_secondary_diagonal - sum_of_primary_diagonal))
